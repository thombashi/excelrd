...
def cell_name_to_rowx_colx(cell_name, letter_value=_UPPERCASE_1_REL_INDEX, allow_no_col=False):
...
class X12Sheet(X12General):
    ...
    def do_merge_cell(self, elem):
        ...
        if ref:
            ...
            self.merged_cells.append((first_rowx, last_rowx + 1, first_colx, last_colx + 1))
...
def open_workbook_2007_xml(
    ...
    # It's easier to check for each instead of parsing XML to find a specific path reference.
